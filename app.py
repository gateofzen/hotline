...
def render_hotline(header, cases, sheet_no=1):
    ...
    for i, case in enumerate(cases):
        ...
        if outcome == "お断り":
            ...
            if reason == "1_満床":
                dm(160, yr1, r=12)   # "1." の上
                sub_map = {
                    "満床": (340,yr1), "満床に準ずる状態": (340,yr1),
                    "ICU個室(感染等)満床": (510,yr1), "熱傷患者受入不能": (705,yr1),
                }
                ...
                dm(295, yr2, r=12)
                sub_map2 = {
                    "他患の処置・手術等で余力なし": (465,yr2),
                    "別の救急患者の搬入直前・直後": (735,yr2),
                }
